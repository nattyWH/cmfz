...
<head>
    <meta charset="UTF-8">
    <!-- 引入 echarts.js -->
    <script src="${app}/echarts/echarts.min.js" charset="UTF-8"></script>
    <script type="text/javascript" src="${app}/echarts/china.js" charset="UTF-8"></script>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $.get("${app}/user/showUserLocation", "json", function (data) {
                myChart.setOption({
                    series: [{
                        name: '男',
                        type: 'map',
